...
public class AdminFrame {
	...
	private void initialize() {
		...
		ImageIcon maximize_button = new ImageIcon("src/images/AdminFrame/maximizeFrameButton.png");
		ImageIcon minimize_button = new ImageIcon("src/images/AdminFrame/minimizeFrameButton.png");
		ImageIcon close_button = new ImageIcon("src/images/AdminFrame/closeFrameButton.png");
		ImageIcon iconifier_button = new ImageIcon("src/images/AdminFrame/iconifierFrameButton.png");
		ImageIcon customer_button = new StretchIcon("src/images/AdminFrame/testbutton.png");
