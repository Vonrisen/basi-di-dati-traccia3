...
public abstract class Persona {
	...
	public String toString(Utente u) {
		return "Persona [codice_fiscale=" + codice_fiscale + ", nome=" + nome + ", cognome=" + cognome + ", indirizzo="
				+ indirizzo + ", data_n=" + data_n + ", luogo_n=" + luogo_n + ", sesso=" + sesso + ", cellulare="
				+ cellulare + "codice_utente=" + u.getCodice_utente() + ", email=" + u.getEmail() + ", password=" + u.getPassword()+ ", flag="
						+ u.getFlag() + "]";
	}
